...
contract Swap is ERC20{
     ...
     */
    constructor(address token_address, string memory _name, string memory _symbol) public ERC20(_name, _symbol) {
    ...
    function swapTokenToToken(uint256 tokens_to_sell, uint256 min_tokens, uint256 min_eth, address exchange_addr ) public {
        ...
        uint256 tokensBought = Swap(exchange_addr).swapEthToTokens{value: ethBought}(min_tokens);
